...
global.eui.registerDraw(() => {
    ...
    Draw.draw(Layer.overlayUI+0.01, () => {
        ...
        // Универсальная проверка для всех версий v7+
...
function buildTable() {
    ...
    // Динамическое обновление прозрачности каждый кадр
    unitTableButtons.update(() => {
        unitTableButtons.color.a = Core.settings.getInt("eui-UnitsTableAlpha", 100) / 100;
    });
